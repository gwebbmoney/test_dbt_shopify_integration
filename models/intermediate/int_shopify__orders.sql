...
SELECT DISTINCT(oi.id) AS order_id,
    ...
    COALESCE(REGEXP_SUBSTR(o.note_attributes, '"name"\s*:\s*"SponsorID"\s*,\s*"order_id"\s*:\s*null\s*,\s*"value"\s*:\s*"([^"]*)"', 1, 1, 'i', 1), 0) AS sponsor_id,
    COALESCE(REGEXP_SUBSTR(o.note_attributes, '"name"\s*:\s*"PartyID"\s*,\s*"order_id"\s*:\s*null\s*,\s*"value"\s*:\s*"([^"]*)"', 1, 1, 'i', 1), 0) AS partyid,
    COALESCE(REGEXP_SUBSTR(o.note_attributes, '"name"\s*:\s*"HostID"\s*,\s*"order_id"\s*:\s*null\s*,\s*"value"\s*:\s*"([^"]*)"', 1, 1, 'i', 1), 0) AS hostid,
    COALESCE(REGEXP_SUBSTR(o.note_attributes, '"name"\s*:\s*"dateOfBirth"\s*,\s*"order_id"\s*:\s*null\s*,\s*"value"\s*:\s*"([^"]*)"', 1, 1, 'i', 1), 0) AS dateofbirth,
    COALESCE(REGEXP_SUBSTR(note_attributes, '"name"\s*:\s*"referrer"\s*,\s*"order_id"\s*:\s*null\s*,\s*"value"\s*:\s*"([^"]*)"', 1, 1, 'i', 1), 0) AS referrer,
    COALESCE(REGEXP_SUBSTR(note_attributes, '"name"\s*:\s*"pws"\s*,\s*"order_id"\s*:\s*null\s*,\s*"value"\s*:\s*"([^"]*)"', 1, 1, 'i', 1), 0) AS pws,
    COALESCE(REGEXP_SUBSTR(note_attributes, '"name"\s*:\s*"PartyWebAlias"\s*,\s*"order_id"\s*:\s*null\s*,\s*"value"\s*:\s*"([^"]*)"', 1, 1, 'i', 1), 0) AS partywebalias,
    o.note_attributes,
