...
SELECT DISTINCT(oi.id) AS order_id,
    ...
    o.created_at::timestamp_ntz AS created_at,
    o.processed_at::timestamp_ntz AS processed_at,
    o.cancelled_at::timestamp_ntz AS cancelled_at,
    ...
    (order_invoice_amount_cents - order_refund_amount_cents) AS total_order_amount_cents,
