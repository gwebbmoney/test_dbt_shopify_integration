...
SELECT DISTINCT(oi.id) AS order_id,
    ...
    DATE_ADD(hours, -7, o.created_at)::timestamp_ntz AS created_at,
    DATE_ADD(hours, -7, o.processed_at)::timestamp_ntz AS processed_at,
    DATE_ADD(hours, -7, o.cancelled_at)::timestamp_ntz AS cancelled_at,
    DATE_ADD(hours, -7, o.updated_at)::timestamp_ntz AS updated_at,
