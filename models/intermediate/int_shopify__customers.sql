...
SELECT c.id AS customer_id,
    ...
    c.note,
    c.verified_email,
    LOWER(c.email_marketing_consent_opt_in_level) AS email_marketing_consent_opt_in_level,
    LOWER(c.email_marketing_consent_state) AS email_marketing_consent_state,
